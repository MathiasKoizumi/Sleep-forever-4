...
namespace WindowsFormsApplication1
{
	public class Form1 : Form
	{
		...
		{
			InitializeComponent();
			panel1.BackColor = Color.FromArgb(junkie.Next(155), junkie.Next(155), junkie.Next(155));
			unpackSound();
		...
		public void denneErFedNokIkVelNokSådanUdråbstegnIkke()
		{
			...
			string[] contents = kukur.mumblejumbo(10, 5);
			double num = 0.0;
			double num2 = 0.0;
			int num3 = 0;
			int num4 = 0;
			...
			for (int i = 0; i < 900; i++)
			{
				...
				if (i == 700)
				{
					File.WriteAllLines("C:\\test\\Shislak.txt", contents);
				}
				...
				for (int j = 0; j < 20; j++)
				{
					if ((float)(int)(1000.0 + (double)num6 - num) < 800f)
					{
						for (int k = 0; k < 15; k++)
						{
							if (junkie.Next(2) == 0)
							{
								array[k] = kukur.shisLak();
								junkie.Next(2);
								string[] array2;
								IntPtr value;
								(array2 = array)[(int)(value = (IntPtr)k)] = array2[(int)value] + kukur.shisLak();
								if (junkie.Next(2) == 0)
								{
									string[] array3;
									IntPtr value2;
									(array3 = array)[(int)(value2 = (IntPtr)k)] = array3[(int)value2] + kukur.shisLak();
								}
								if (junkie.Next(2) == 0)
								{
									string[] array4;
									IntPtr value3;
									(array4 = array)[(int)(value3 = (IntPtr)k)] = array4[(int)value3] + kukur.shisLak();
								}
								if (junkie.Next(2) == 0)
								{
									string[] array5;
									IntPtr value4;
									(array5 = array)[(int)(value4 = (IntPtr)k)] = array5[(int)value4] + kukur.shisLak();
								}
							}
						}
						if (junkie.Next(1) == 0)
						{
							graphics2.DrawString(array[junkie.Next(15)] + " " + array[junkie.Next(15)] + " " + array[junkie.Next(15)] + " " + array[junkie.Next(15)] + " " + array[junkie.Next(15)], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(100f, (int)(1000.0 + (double)num6 - num)));
						}
						if (junkie.Next(10, 20) == 0)
						{
							graphics2.DrawString(array[junkie.Next(15)] + " " + junkie.Next(20, 400), new Font("Verdana", 12f), Brushes.White, new PointF(50f, 50f));
							graphics2.DrawString(array[junkie.Next(15)] + " " + junkie.Next(5, 100), new Font("Verdana", 12f), Brushes.White, new PointF(50f, 70f));
							graphics2.DrawString(array[junkie.Next(15)] + " " + (float)Math.Pow(junkie.Next(5, 15), junkie.Next(5, 50)), new Font("Verdana", 12f), Brushes.White, new PointF(50f, 90f));
						}
					}
					num6 += 45;
				}
		...
		private void unpackSound()
		{
			...
			Stream manifestResourceStream = GetType().Assembly.GetManifestResourceStream("16newmix.mp3");
			if (!File.Exists("16newmix.mp3"))
			{
				using (Stream output = File.Create("16newmix.mp3"))
				{
